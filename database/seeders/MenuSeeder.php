...
class MenuSeeder extends Seeder
{
    protected const ITEMS = [
        ...
        ['title' => 'スキルカテゴリーソート', 'parent_id' => 0,'order' => 6, 'icon' => 'fa-sort-amount-desc', 'uri' => 'skil-sort'],
        ['title' => 'スキルソート', 'parent_id' => 0,'order' => 7, 'icon' => 'fa-sort-amount-desc', 'uri' => 'skil-tool-sort'],
        ['title' => 'ワークカテゴリー', 'parent_id' => 0,'order' => 8, 'icon' => 'fa-sort-amount-desc', 'uri' => 'work-categories'],
